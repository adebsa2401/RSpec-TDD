...
# 📖 RSpec-TDD <a name="about-project"></a>
...
```sh
  cd my-folder
  git clone git@github.com:adebsa2401/RSpec-TDD.git
```
...
- LinkedIn: [rahman-mujeeb](https://www.linkedin.com/in/rahman-mujeeb/)
...
Feel free to check the [issues page](https://github.com/adebsa2401/RSpec-TDD/issues).
...
- Thanks to the my coding partner for great contributions.
...
This project is [MIT](https://github.com/adebsa2401/RSpec-TDD/blob/spec/solver/LIcence) licensed.
